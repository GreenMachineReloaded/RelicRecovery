 ...
 */
@TeleOp(name = "Auto B1", group = "Blue")
        ...
        public void loop(){
            ...
            switch(state){
                ...
                case DRIVEOFF:
                    ...
                    if(drive.getPitch() >= -1 && drive.getPitch() <= 1){
                        drive.stop();
                ...
                case TURNBOX:
                    //Turns left to face CryptoBox. UNTESTED/DEACTIVATED
                    if(!isFinished){
